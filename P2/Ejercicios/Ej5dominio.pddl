(define (domain Ejercicio5)
    ...
    (:functions
      ...
      (daPuntos ?p - Npc ?o - ObjetoEntregable)
      (maxBolsillo ?p - Npc)
      (nBolsillo ?p - Npc)
      (puntosTotales)
    )
    ...
    (:action entregarObjeto
      ...
      :effect (and (tiene ?p ?o) (not (tiene ?j ?o)) (not (manoLlena ?j)) (increase (puntosJugador ?j) (daPuntos ?p ?o)) (increase (puntosTotales) (daPuntos ?p ?o)) (increase (nBolsillo ?p) 1))
    )
