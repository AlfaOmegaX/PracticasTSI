(define (problem Problema7)
		...
		(:init
				...
				(= (maxBolsillo bruja1) 2)
				(= (nBolsillo bruja1) 0)
				(= (maxBolsillo princesa1) 2)
				(= (nBolsillo princesa1) 0)
				(= (maxBolsillo princesa2) 2)
				(= (nBolsillo princesa2) 0)
				(= (maxBolsillo profesor1) 2)
				(= (nBolsillo profesor1) 0)
				(= (maxBolsillo leonardo1) 2)
				(= (nBolsillo leonardo1) 0)
		)

		(:goal (and (>= (puntosJugador jugador1) 50) (>= (puntosTotales) 50)))
