(define (problem Problema3)
		...
		(:objects
				...
				manzana1 - Manzana
				oscar1 - Oscar
				algoritmo2 algoritmo3 - Algoritmo
				oro1 - Oro
				rosa1 rosa2 - Rosa
		...
		(:goal (and (tiene profesor1 oscar1) (tiene principe1 oro1) (tiene princesa1 rosa1) (tiene princesa2 algoritmo2) (tiene bruja1 rosa2) (tiene leonardo1 algoritmo3)))
