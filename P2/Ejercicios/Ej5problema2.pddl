(define (problem Problema5)
		...
		(:init
				...
				(= (daPuntos principe2 manzana1) 4)
				(= (daPuntos principe2 manzana2) 4)
				(= (daPuntos principe2 oscar1) 1)
				(= (daPuntos principe2 algoritmo1) 5)
				(= (daPuntos principe2 oro1) 10)
				(= (daPuntos principe2 oro2) 10)
				(= (daPuntos principe2 oro3) 10)
				(= (daPuntos principe2 rosa1) 3)
				(= (daPuntos principe2 rosa2) 3)
				(= (daPuntos principe2 rosa3) 3)
				...
				(= (maxBolsillo principe2) 1)
				(= (nBolsillo principe2) 0)
