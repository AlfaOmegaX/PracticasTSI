(define (problem Problema1)
		...
		(:objects
				jugador1 - Player
				profesor1 - Profesor
				principe1 principe2 - Principe
				princesa1 - Princesa
				bruja1 - Bruja
				leonardo1 leonardo2 - Leonardo
				manzana1 - Manzana
				oscar1 - Oscar
		...
		(:init
				...
				(estaEn rosa2 z15)
				(estaEn algoritmo2 z16)
				(estaEn profesor1 z18)
				(estaEn manzana1 z21)
				(estaEn principe2 z24)
				(estaEn leonardo2 z24)
		...
		(:goal (and (tiene profesor1 oscar1) (tiene principe1 oro1) (tiene principe2 rosa1) (tiene princesa1 algoritmo1) (tiene bruja1 rosa2) (tiene leonardo1 algoritmo2) (tiene leonardo2 manzana1)))
)